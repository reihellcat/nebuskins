...
const Thanks = ({ id, go, AllowMessage }) => (
  <Panel id={id}>
    ...
    <Div>
      <Text weight="medium" style={{ marginBottom: 16, textAlign: "center" }}>
        В личные сообщения сообщества будет отправлено сообщение об информации
        отправленого скина. Убедитесь, что Вы разрешили сообществу писать личные
        сообщения, иначе скин будет отклонен.
      </Text>
      {/* <Cell>
   <Button onClick={AllowMessage} size="xl" mode="secondary">Разрешить писать сообщения</Button>
   </Cell> */}
      <Cell>
        <Button onClick={go} data-to="home" size="xl" mode="secondary">
          Главное меню
        </Button>
      </Cell>
    </Div>
