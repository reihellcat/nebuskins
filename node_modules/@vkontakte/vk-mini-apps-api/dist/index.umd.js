(function (global, factory) {
    ...
    (global = global || self, factory(global.vkMiniAppsAPI = {}));
    ...
    ***************************************************************************** */
    ...
    var promisifySend = function (send, subscribe) {
      ...
      return function (method, props) {
        return new Promise(function (resolve, reject) {
          ...
          send(method, __assign$1(__assign$1({}, props), {
    ...
    var VKConnectProvider = /** @class */ (function () {
        /** @ignore */
        function VKConnectProvider(customConnect) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.connect.sendPromise('VKWebAppOpenPayForm', props)];
                        case 1:
                            resp = _a.sent();
    ...
    exports.VKMiniAppAPI = VKMiniAppAPI;
