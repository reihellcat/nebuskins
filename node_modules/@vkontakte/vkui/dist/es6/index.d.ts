 ...
 */
import { FormStatusType as _FormStatusType, AlignType as _AlignType, HasPlatform as _HasPlatform, HasInsets as _HasInsets } from './types';
import { OSType as _OSType } from './lib/platform';
export declare type OSType = _OSType;
export declare type FormStatusType = _FormStatusType;
export declare type AlignType = _AlignType;
export declare type HasPlatform = _HasPlatform;
export declare type HasInsets = _HasInsets;
